...
<Canvas>
  <Story
    ...
    parameters={{
      mockData: [
        {
          url: `${GROUP_DATA.urls.refData}/areYouACivilServant`,
          method: 'GET',
          status: 200,
          response: CIVIL_SERVANT,
        },
        {
          url: `${GROUP_DATA.urls.refData}/grade`,
          method: 'GET',
          status: 200,
          response: GRADE,
        },
        {
          url: `${GROUP_DATA.urls.refData}/team`,
          method: 'GET',
          status: 200,
          response: TEAMS,
        },
  ...
  >
    {() => {
      ...
      //const DATA = { firstName: 'John', surname: 'Smith', age: 41, team: 'London' };
      const PAGES = Utils.FormPage.getAll(
        GROUP.pages,
        GROUP.components,
        { ...DATA }
