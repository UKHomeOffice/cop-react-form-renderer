  ...
  describe('Validate', () => {
    describe('time', () => {
      ...
      test('should return an error if the hour is not between 0 and 23', () => {
        const output = validateTime('35:30');
      ...
      test('should return an error if the minute is not between 0 and 59', () => {
        const output = validateTime('14:75');
