...
* #### `group: [object]`
The value for this object are `id, label and component` component is a array of string.
  * `""id": "address-details"`: The is a page Id.
  * `"groupLabel": "UK address""`: This value will be key for the group label.
  * `"groups[]"`: Groups conatins an object which has an array of the component `""groups": [
          {
            "id": "address",
